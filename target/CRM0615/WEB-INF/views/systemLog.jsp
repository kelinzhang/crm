...
<body>
	...
	<table id="systemLog_datagrid">
		<thead>
			<tr>
				...
				<th data-options="field:'opUser',width:1,align:'center',formatter:userFormat">操作者</th>
				<th data-options="field:'opTime',width:1,align:'center'">操作时间</th>
				<th data-options="field:'params',width:1,align:'center'">参数</th>
				<th data-options="field:'function',width:1,align:'center'">操作表达式</th>
			</tr>
		</thead>
	</table>
	<!-- 新增编辑对话框 -->
	<div id="systemLog_dialog">
		...
		<table align="center" style="margin-top: 15px;">
			...
			<tr>
				<td>操作者</td>
				<td><input type="text" name="opUser.id"></td>
			</tr>
			<tr>
				<td>操作时间</td>
